    ...
    <div>
      ...
      <div className="container-fluid py-5">
          <div className="container py-5">
              ...
              <div className="row">
                  ...
                  <div className="col-lg-4" style="min-height: 400px;">
      ...
      <div className="container-fluid my-5 py-5 px-0">
          <div className="row bg-primary m-0">
              <div className="col-md-6 px-0" style="min-height: 500px;">
                  <div className="position-relative h-100">
                      <img className="position-absolute w-100 h-100" src="img/promotion.jpg" style="object-fit: cover;" />
              ...
              <div className="row">
                  <div className="col-12">
                      <div className="owl-carousel service-carousel">
                          ...
                          <div className="service-item">
                              <div className="service-img mx-auto">
                                  <img className="rounded-circle w-100 h-100 bg-light p-3" src="img/service-3.jpg" style="object-fit: cover;" />
                              </div>
                              <div className="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                          ...
                          <div className="service-item">
                              <div className="service-img mx-auto">
                                  <img className="rounded-circle w-100 h-100 bg-light p-3" src="img/service-4.jpg" style="object-fit: cover;" />
                              </div>
                              <div className="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
              ...
              <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                  <div className="position-relative overflow-hidden">
                      ...
                      <a className="portfolio-btn" href="img/portfolio-1.jpg" data-lightbox="portfolio">
                          <i className="fa fa-plus text-primary" style="font-size: 60px;"></i>
                      </a>
                  </div>
              </div>
              <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                      ...
                      <div className="owl-carousel product-carousel">
                          <div className="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                              ...
                              <div className="position-relative bg-primary rounded-circle mt-n3 mb-4 p-3" style="width: 150px; height: 150px;">
                                  <img className="rounded-circle w-100 h-100" src="img/product-1.jpg" style="object-fit: cover;" />
                              </div>
                          ...
                          <div className="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                              ...
                              <div className="position-relative bg-primary rounded-circle mt-n3 mb-4 p-3" style="width: 150px; height: 150px;">
                                  <img className="rounded-circle w-100 h-100" src="img/product-2.jpg" style="object-fit: cover;" />
                              </div>
                              <h5 className="font-weight-bold mb-4">Vanilla Ice Cream</h5>
                              <a href="/" className="btn btn-sm btn-secondary">Order Now</a>
                          </div>
                          <div className="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                              ...
                              <div className="position-relative bg-primary rounded-circle mt-n3 mb-4 p-3" style="width: 150px; height: 150px;">
                                  <img className="rounded-circle w-100 h-100" src="img/product-3.jpg" style="object-fit: cover;" />
                              </div>
                              <h5 className="font-weight-bold mb-4">Vanilla Ice Cream</h5>
                              <a href="/" className="btn btn-sm btn-secondary">Order Now</a>
                          </div>
                          <div className="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                              ...
                              <div className="position-relative bg-primary rounded-circle mt-n3 mb-4 p-3" style="width: 150px; height: 150px;">
                                  <img className="rounded-circle w-100 h-100" src="img/product-4.jpg" style="object-fit: cover;" />
                              </div>
                              <h5 className="font-weight-bold mb-4">Vanilla Ice Cream</h5>
                              <a href="/" className="btn btn-sm btn-secondary">Order Now</a>
                          </div>
                          <div className="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                              ...
                              <div className="position-relative bg-primary rounded-circle mt-n3 mb-4 p-3" style="width: 150px; height: 150px;">
                                  <img className="rounded-circle w-100 h-100" src="img/product-5.jpg" style="object-fit: cover;" />
                              </div>
                              <h5 className="font-weight-bold mb-4">Vanilla Ice Cream</h5>
                              <a href="/" className="btn btn-sm btn-secondary">Order Now</a>
                          </div>
                      ...
                      <div className="owl-carousel team-carousel">
                          <div className="team-item">
                              <div className="team-img mx-auto">
                                  <img className="rounded-circle w-100 h-100" src="img/team-1.jpg" style="object-fit: cover;" />
                              </div>
                              <div className="position-relative text-center bg-light rounded px-4 py-5" style="margin-top: -100px;">
                          ...
                          <div className="team-item">
                              <div className="team-img mx-auto">
                                  <img className="rounded-circle w-100 h-100" src="img/team-2.jpg" style="object-fit: cover;" />
                              </div>
                              <div className="position-relative text-center bg-light rounded px-4 py-5" style="margin-top: -100px;">
                                  <h3 className="font-weight-bold mt-5 mb-3 pt-5">Full Name</h3>
                                  <h6 className="text-uppercase text-muted mb-4">Designation</h6>
                          ...
                          <div className="team-item">
                              <div className="team-img mx-auto">
                                  <img className="rounded-circle w-100 h-100" src="img/team-3.jpg" style="object-fit: cover;" />
                              </div>
                              <div className="position-relative text-center bg-light rounded px-4 py-5" style="margin-top: -100px;">
                                  <h3 className="font-weight-bold mt-5 mb-3 pt-5">Full Name</h3>
                                  <h6 className="text-uppercase text-muted mb-4">Designation</h6>
                          ...
                          <div className="team-item">
                              <div className="team-img mx-auto">
                                  <img className="rounded-circle w-100 h-100" src="img/team-4.jpg" style="object-fit: cover;" />
                              </div>
                              <div className="position-relative text-center bg-light rounded px-4 py-5" style="margin-top: -100px;">
                                  <h3 className="font-weight-bold mt-5 mb-3 pt-5">Full Name</h3>
                                  <h6 className="text-uppercase text-muted mb-4">Designation</h6>
      ...
      {/* <-- Footer Start --> */}
      <div className="container-fluid footer bg-light py-5" style="margin-top: 90px;">
